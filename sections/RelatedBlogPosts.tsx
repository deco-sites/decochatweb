  ...
  return (
    <div className="w-full min-w-full bg-dc-50 flex flex-col justify-start items-center overflow-hidden px-4 md:px-8 lg:px-16 py-8 md:py-16 gap-8 md:gap-14">
      <div className="w-full flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <h2 className="text-dc-800 text-4xl font-semibold font-manrope leading-tight">
          {heading}
        </h2>
        <Button
          variant="secondary"
          ...
          {displayPosts.map((post, index) => (
            ...
            >
              ...
              <div className="w-full flex flex-col justify-start items-start gap-4">
                ...
                >
                  <h3 className="text-dc-800 text-xl md:text-2xl font-semibold font-manrope leading-tight">
                    {post.title}
                  </h3>
                </a>
                ...
                <div className="inline-flex justify-start items-center gap-3">
                  ...
                  {post.date && (
                    <>
                      ...
                      <div className="text-dc-500 text-sm font-medium font-manrope leading-tight">
