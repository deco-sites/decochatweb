...
export default function PrivacySecurity({
  ...
  return (
    <div class="self-stretch p-2 flex flex-col justify-start items-start gap-2.5">
      <div class="w-full max-w-[1440px] px-8 md:px-16 py-16 md:py-32 relative bg-primary-dark rounded-2xl flex flex-col justify-center items-center gap-12 md:gap-20 overflow-hidden mx-auto">
        {/* Background Image */}
        {backgroundImage && (
