...
const PARAGRAPH_STYLES =
  "[&_p]:text-dc-600 [&_p]:text-xl [&_p]:font-medium [&_p]:font-main [&_p]:leading-loose [&_p]:mb-6";
const HEADING_STYLES =
  "[&>h1]:text-dc-800 [&>h1]:text-4xl [&>h1]:font-semibold [&>h1]:font-main [&>h1]:leading-tight [&>h1]:my-10 " +
  "[&>h2]:text-dc-800 [&>h2]:text-3xl [&>h2]:font-semibold [&>h2]:font-main [&>h2]:leading-10 [&>h2]:mt-10 [&>h2]:mb-6 " +
  "[&>h3]:text-dc-800 [&>h3]:text-2xl [&>h3]:font-semibold [&>h3]:font-main [&>h3]:leading-7 [&>h3]:mt-10 [&>h3]:mb-4 " +
  "[&>h4]:text-dc-800 [&>h4]:text-xl [&>h4]:font-semibold [&>h4]:font-main [&>h4]:leading-7 [&>h4]:mt-8 [&>h4]:mb-4 " +
  "[&>h5]:text-dc-800 [&>h5]:text-lg [&>h5]:font-semibold [&>h5]:font-main [&>h5]:leading-tight [&>h5]:mt-6 [&>h5]:mb-3 " +
  "[&>h6]:text-dc-800 [&>h6]:text-base [&>h6]:font-semibold [&>h6]:font-main [&>h6]:leading-tight [&>h6]:mt-6 [&>h6]:mb-3";
...
const LIST_STYLES =
  "[&>ul]:list-disc [&>ul]:pl-6 [&>ul]:mb-6 [&>ul]:text-dc-600 [&>ul]:text-xl [&>ul]:font-medium [&>ul]:font-main [&>ul]:leading-loose " +
  "[&>ol]:list-decimal [&>ol]:pl-6 [&>ol]:mb-6 [&>ol]:text-dc-600 [&>ol]:text-xl [&>ol]:font-medium [&>ol]:font-main [&>ol]:leading-loose";
        ...
        <div className="w-full md:w-[700px] max-w-[700px] flex flex-col justify-start items-start gap-8 relative z-10">
          <div className="self-stretch flex flex-col justify-start items-center gap-6">
            <div className="self-stretch flex flex-col justify-start items-center gap-4">
              ...
              <h1 className="self-stretch text-center text-dc-800 text-4xl md:text-5xl lg:text-6xl font-semibold font-main leading-tight">
                {title}
              </h1>
            </div>
            <div className="inline-flex flex-wrap justify-center items-center gap-4">
              ...
              {formattedDate && (
                <>
                  ...
                  <div className="justify-start text-dc-500 text-xl font-medium font-main">
                    {formattedDate}
                  </div>
                </>
              )}
                  ...
                  <div className="flex flex-wrap justify-start items-start gap-2">
                    {categories.map((category, index) => {
                      ...
                      return (
                        ...
                        >
                          <div className="justify-center text-dc-600 text-base font-semibold font-main leading-tight">
                            {category.name}
                          </div>
                        </a>
                      );
