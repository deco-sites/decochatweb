      ...
      <section id={id} data-page={page}>
            ...
            {featuredPosts.map((post) => (
              <div class="flex flex-col justify-start items-start">
                ...
                <div class="self-stretch py-6 flex flex-col justify-start items-start gap-4">
                  ...
                  >
                    <h2 class="self-stretch text-dc-800 text-2xl md:text-3xl font-semibold font-manrope leading-tight md:leading-10">
                      {post.title}
                    </h2>
                  </a>
                  ...
                  <div class="inline-flex justify-start items-center gap-3">
                    ...
                    {post.date && (
                      <>
                        ...
                        <div class="text-dc-500 text-sm font-medium font-manrope leading-tight">
        ...
        {searchTerm && filteredPosts && filteredPosts.length === 0 && (
          <div class="w-full flex flex-col items-center justify-center py-12 text-center">
            <h2 class="text-dc-800 text-2xl font-semibold font-manrope mb-2">
              No posts found
            </h2>
            <p class="text-dc-600 text-lg font-manrope mb-6">
              We couldn't find any posts matching "{searchTerm}"
            </p>
            <a
              href="/blog"
              class="px-4 py-2 bg-primary-light text-primary-dark rounded-xl font-semibold font-manrope hover:opacity-90 transition-opacity"
            >
              Back to all posts
            </a>
          </div>
              ...
              <div class="flex flex-col justify-start items-start">
                ...
                <div class="self-stretch py-6 flex flex-col justify-start items-start gap-4">
                  ...
                  <a
                    ...
                    class="block w-full hover:opacity-80 transition-opacity"
                  >
                    <h3 class="self-stretch text-dc-800 text-xl md:text-2xl font-semibold font-manrope leading-tight md:leading-7">
                      {post.title}
                    </h3>
                  </a>
        ...
        {filteredPosts && to < filteredPosts.length && (
          <div class="flex justify-center w-full mt-8">
            <a
              href={getNextPageUrl()}
              class="px-4 py-2 bg-primary-light text-primary-dark rounded-xl font-semibold font-manrope"
            >
              {cta.text}
            </a>
          </div>
