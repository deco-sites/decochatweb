        ...
        <div class="flex flex-wrap justify-start items-center gap-2">
          {allBlogCategories.map((category) => {
            ...
            return (
              ...
              >
                <div class="text-dc-600 text-base font-semibold font-main leading-tight">
                  {category.name}
                </div>
              </a>
            );
          ...
          >
            <div class="flex-1 w-full px-4 py-2.5 bg-dc-50 rounded-xl outline outline-1 outline-offset-[-1px] outline-dc-200 flex justify-start items-center gap-1 overflow-hidden">
              ...
              <input
                ...
                class="flex-1 bg-transparent border-none outline-none text-dc-800 placeholder:text-dc-400 text-lg font-normal font-main leading-tight"
              />
