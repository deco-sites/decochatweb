    ...
    <div class={`flex justify-start items-center gap-2 ${className}`}>
      <div class="flex justify-start items-center relative group">
        ...
        {showTooltip && validAuthors.length > 1 && (
          <div class="absolute top-full left-0 mt-2 bg-dc-50 shadow-md rounded-md px-3 py-2 text-sm text-dc-600 font-main font-medium opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 whitespace-nowrap z-50">
      ...
      {showName && validAuthors[0]?.name && (
        <div
          ...
          } font-medium font-main leading-tight`}
        >
          {validAuthors[0].name}
